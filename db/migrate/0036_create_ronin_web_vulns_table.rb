...
class CreateRoninWebVulnsTable < ActiveRecord::Migration[7.0]
  ...
  def change
    create_table :ronin_web_vulns, if_not_exists: true do |t|
      ...
      t.integer :lfi_os, null: true
      t.integer :lfi_depth, null: true
      t.integer :lfi_filter_bypass, null: true
      t.integer :rfi_script_lang, null: true
      t.integer :rfi_filter_bypass, null: true
      t.integer :ssti_escape, null: true
