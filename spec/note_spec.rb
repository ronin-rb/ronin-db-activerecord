  ...
  describe "validations" do
    ...
    it "must have at least one belongs_to association set" do
      ...
      expect(note.errors[:base]).to eq(
        ['note must be associated with a MACAddress, IPAddress, HostName, Port, Service, OpenPort, Cert, URL, UserName, EmailAddress, Password, Credential, Advisory, PhoneNumber, or StreetAddress']
      )
