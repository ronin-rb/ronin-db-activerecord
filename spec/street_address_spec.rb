...
describe Ronin::DB::StreetAddress do
  ...
  describe ".for_person" do
    ...
    it "must return the #{described_class}s associated with the person's full name" do
      street_addresses = subject.for_person(full_name)
      ...
      expect(street_addresses[0].people.length).to eq(1)
      expect(street_addresses[0].people[0].full_name).to eq(full_name)
      ...
      expect(street_addresses[1].people.length).to eq(1)
      expect(street_addresses[1].people[0].full_name).to eq(full_name)
    end
  ...
  describe ".with_province" do
    ...
    it "must return the #{described_class} with the matching state" do
      street_addresses = subject.with_province(state)
  ...
  describe ".with_state" do
    ...
    it "must return the #{described_class} with the matching country" do
      street_addresses = subject.with_country(country)
